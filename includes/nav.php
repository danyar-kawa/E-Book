    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center py-3">
            ...
            <div class="icons d-flex">
                ...
                ?>
                <a href="../order/cart.php" class="text-white"><i class="fas fa-shopping-cart"></i> <span>(<?php echo $cart_rows_number; ?>)</span></a>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body"><?php if (isset($_SESSION['user_id'])) { ?>
                    ...
                    <a class="nav-link btn-primary text-light text-center" href="../home/login.php">Login</a>
                <?php }  ?>
            </div>
        </div>
    </div>
